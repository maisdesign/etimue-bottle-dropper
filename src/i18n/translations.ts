...
export const translations = {
  en: {
    ...
    instructionsMobileTouch: '• On mobile: Joystick (left) + E button (right) to jump',
  ...
  it: {
    ...
    instructionsMobileTouch: '• Su mobile: Joystick (sinistra) + pulsante E (destra) per saltare',
